...
def execute(path, grammar_file_name, example_file_name, export_dot, export_png):
    ...
    # u ovom delu generisemo views.py file i klase i funkcije vezane za taj fajl
    def function(model):
    ...
    # u ovom delu generisemo models.py file, klase i funkcije vezane za taj fajl
    def functionM(model):
